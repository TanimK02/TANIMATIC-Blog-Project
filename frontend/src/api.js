...
export const updateComment = (commentId, content) => axiosAuth.put(`/comments/comment/${commentId}`, { content })
export const deleteComment = (commentId) => axiosAuth.delete(`/comments/comment/${commentId}`)